...
var MarketItem = artifacts.require('./MarketItem');
...
contract('NFTMarketplace', accounts => {
  ...
  before(async () => {
    nftContract = await MarketItem.new();
  ...
  describe('Fill Offer', () => {
    ...
    it('Cannot be fulfilled twice', async () => {
      await expectRevert(
        mktContract.fillOffer(1, { from: accounts[1] }),
        'An offer cannot be fulfilled twice',
      );
    });
  ...
  describe('Cancel Offer', () => {
    ...
    it('Cannot be cancelled twice', async () => {
      await expectRevert(
        mktContract.cancelOffer(2, { from: accounts[0] }),
  ...
  describe('Claim funds', () => {
    it('Rejects users without funds to claim', async () => {
      await expectRevert(
        mktContract.claimFunds({ from: accounts[1] }),
